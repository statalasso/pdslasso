...
{phang2}. {stata "ivlasso CSIndex (NumProCase = Z*), nocons robust rlasso lopt(lalt corrnum(0) maxupsiter(100))"}{p_end}
{phang2}. {stata "estimates replay _ivlasso_step5"}{p_end}
